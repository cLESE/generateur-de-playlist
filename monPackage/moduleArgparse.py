...
def fonctionArgparse():
    ...
    parser.add_argument("-a", "--album", help="album voulu dans la playlist", nargs=2, action="append")
    parser.add_argument("-t", "--titre", help="titre voulu dans la playlist", nargs=2, action="append")
